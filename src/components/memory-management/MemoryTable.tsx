...
export function MemoryTable({ title, instructions }: MemoryTableProps) {
  const isInstructions = instructions[0].instruction !== undefined;
        ...
        <thead className="bg-gray-50">
          <tr>
            <th className="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900">
              {isInstructions ? 'Instruction' : 'Attribute'}
            </th>
            {isInstructions && (
